...
on_exit() {
  ...
  callback_args=(
    ...
    --note "ROB-68 follow-up: fill 16384-context RMM repeats 2 and 3 so each dataset/epoch setting has 3 repeats total. Inspect lcasr/results/rmm_eval/ctc_seq16384 summary files and logs before finalizing."
  )
