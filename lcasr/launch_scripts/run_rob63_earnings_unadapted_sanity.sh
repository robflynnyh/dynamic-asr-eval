...
RESULTS_ROOT=${RESULTS_ROOT:-"./results/enc_dec/rob63_earnings_unadapted_sanity"}
...
if [ "$DRY_RUN" != "1" ]; then
  "$PYTHON_BIN" results/enc_dec/rob63_earnings_unadapted_sanity/aggregate.py \
    --directory results/enc_dec/rob63_earnings_unadapted_sanity/pkl \
    --csv results/enc_dec/rob63_earnings_unadapted_sanity/summary.csv \
    --outcome results/enc_dec/rob63_earnings_unadapted_sanity/OUTCOME.md
fi
