...
RESULTS_ROOT=${RESULTS_ROOT:-"./results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark"}
...
if [ "$DRY_RUN" != "1" ]; then
  "$PYTHON_BIN" results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/aggregate.py \
