...
do
    echo $epoch
    CUDA_VISIBLE_DEVICES="3" python run_seq_eval.py -dfa -epochs $epoch -seq 16384 -o 14336 -nsti_s -1 -nsti_o 0  --dataset earnings22 -r 1  -kwargs optim_lr=0.00009 spec_augment_n_freq_masks=6 spec_augment_freq_mask_param=34  spec_augment_n_time_masks=0 -s "./results/seqlens/earnings22-360000-plus-epoch-$epoch-test.pkl"
