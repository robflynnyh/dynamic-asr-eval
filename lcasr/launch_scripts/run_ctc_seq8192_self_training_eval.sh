...
# ROB-115: CTC self-training eval for the 8192-context checkpoint.
...
RESULTS_DIR=${RESULTS_DIR:-"./results/ctc_seq8192_self_training_eval"}
...
run_eval() {
    ...
    echo "max_records=${MAX_RECORDS:-unset}" | tee -a "$log_path"
