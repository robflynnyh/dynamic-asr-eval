...
# ROB-110: no-adapt CTC baseline for the 16384-context checkpoint.
# Run from lcasr/. When launched through with-gpu, inherit its
# CUDA_VISIBLE_DEVICES assignment; set GPU manually only for local one-offs.
...
RESULTS_DIR=${RESULTS_DIR:-"./results/ctc_seq16384_unadapted_baseline"}
