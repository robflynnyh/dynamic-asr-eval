...
- Pickles: `./results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev_refine/*_1.pkl`
- Logs: `./results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev_refine/logs/*.log`
- Baseline summary: `./results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/summary.csv`
...
From `results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/summary.csv`, the strongest previous
