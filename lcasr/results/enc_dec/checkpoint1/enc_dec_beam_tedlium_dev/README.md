...
```text
results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/tedlium-dev-<run>-seq2048-overlap0_<repeat>.pkl
```

Logs are written under:

```text
results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/logs/
```

The detached screen launch log from the first sweep is:

```text
results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/sweep_screen.log
```
...
```bash
python3.10 results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/aggregate.py
```

JSON:

```bash
python3.10 results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/aggregate.py --json
```

CSV:

```bash
python3.10 results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/aggregate.py --csv results/enc_dec/checkpoint1/enc_dec_beam_tedlium_dev/summary.csv
```
