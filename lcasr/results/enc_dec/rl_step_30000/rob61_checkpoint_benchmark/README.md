...
```bash
screen -L -Logfile lcasr/results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/screen.log \
...
screen -L -Logfile lcasr/results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/rob63_remaining_normal_baselines_screen.log \
...
- Pickles: `results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/pkl/`
- Logs: `results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/logs/`
- Summary CSV: `results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/summary.csv`
- Markdown outcome: `results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/OUTCOME.md`

Aggregation:

```bash
python3.10 results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/aggregate.py \
  --csv results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/summary.csv \
  --outcome results/enc_dec/rl_step_30000/rob61_checkpoint_benchmark/OUTCOME.md
```
