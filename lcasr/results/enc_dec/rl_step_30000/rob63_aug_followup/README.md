...
```bash
screen -L -Logfile lcasr/results/enc_dec/rl_step_30000/rob63_aug_followup/screen.log \
...
- Pickles: `results/enc_dec/rl_step_30000/rob63_aug_followup/pkl/`
- Logs: `results/enc_dec/rl_step_30000/rob63_aug_followup/logs/`
- Summary CSV: `results/enc_dec/rl_step_30000/rob63_aug_followup/summary.csv`
- Markdown outcome: `results/enc_dec/rl_step_30000/rob63_aug_followup/OUTCOME.md`
...
python3.10 results/enc_dec/rl_step_30000/rob63_rl_self_training_compare/aggregate.py \
  --directory results/enc_dec/rl_step_30000/rob63_aug_followup/pkl \
  --csv results/enc_dec/rl_step_30000/rob63_aug_followup/summary.csv \
  --outcome results/enc_dec/rl_step_30000/rob63_aug_followup/OUTCOME.md
```
