...
```bash
screen -L -Logfile lcasr/results/enc_dec/rob63_best_ce_remaining_datasets/screen.log \
...
- Pickles: `results/enc_dec/rob63_best_ce_remaining_datasets/pkl/`
- Logs: `results/enc_dec/rob63_best_ce_remaining_datasets/logs/`
- Summary CSV: `results/enc_dec/rob63_best_ce_remaining_datasets/summary.csv`
- Markdown outcome: `results/enc_dec/rob63_best_ce_remaining_datasets/OUTCOME.md`

Aggregation:

```bash
python3.10 results/enc_dec/rob63_rl_self_training_compare/aggregate.py \
  --directory results/enc_dec/rob63_best_ce_remaining_datasets/pkl \
  --csv results/enc_dec/rob63_best_ce_remaining_datasets/summary.csv \
  --outcome results/enc_dec/rob63_best_ce_remaining_datasets/OUTCOME.md
```
