...
```bash
screen -L -Logfile lcasr/results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/screen.log \
...
```bash
screen -L -Logfile lcasr/results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/resume_screen.log \
...
- Pickles: `results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/pkl/`
- Logs: `results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/logs/`
- Summary CSV: `results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/summary.csv`
- Markdown outcome: `results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/OUTCOME.md`

Aggregation:

```bash
python3.10 results/enc_dec/checkpoint2/rob63_rl_self_training_compare/aggregate.py \
  --directory results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/pkl \
  --csv results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/summary.csv \
  --outcome results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/OUTCOME.md
```
