...
`results/enc_dec/checkpoint2/rob63_best_ce_remaining_datasets/`,
`results/enc_dec/checkpoint2/rob63_lower_lr_dev_followup/`,
`results/enc_dec/checkpoint2/rob63_aug_followup/`,
`results/enc_dec/checkpoint2/rob63_strong_aug_filter_followup/`, and
`results/enc_dec/checkpoint2/rob63_targeted_high_aug_followup/`. Use
...
```bash
screen -L -Logfile lcasr/results/enc_dec/checkpoint2/rob63_rl_self_training_compare/screen.log \
...
- Pickles: `results/enc_dec/checkpoint2/rob63_rl_self_training_compare/pkl/`
- Logs: `results/enc_dec/checkpoint2/rob63_rl_self_training_compare/logs/`
- Summary CSV: `results/enc_dec/checkpoint2/rob63_rl_self_training_compare/summary.csv`
- Markdown outcome: `results/enc_dec/checkpoint2/rob63_rl_self_training_compare/OUTCOME.md`
- Combined ROB-63 readout: `results/enc_dec/checkpoint2/rob63_rl_self_training_compare/COMBINED_OUTCOME.md`

Aggregation:

```bash
python3.10 results/enc_dec/checkpoint2/rob63_rl_self_training_compare/aggregate.py \
  --csv results/enc_dec/checkpoint2/rob63_rl_self_training_compare/summary.csv \
  --outcome results/enc_dec/checkpoint2/rob63_rl_self_training_compare/OUTCOME.md
```
...
`results/enc_dec/checkpoint2/rob61_checkpoint_benchmark/summary.csv` by default. It records
