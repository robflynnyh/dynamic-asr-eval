...
GPU=<free_gpu>
screen -L -Logfile results/enc_dec/enc_dec_teacher_epoch_relabel/logs/screen_tedlium_dev_epoch_relabel_kl_gpu${GPU}.log -dmS tedlium_dev_epoch_relabel_kl_gpu${GPU} bash -lc "GPU=${GPU} bash launch_scripts/tune_enc_dec_teacher_epoch_relabel_tedlium_dev.sh"
```
...
```bash
screen -ls
tail -f results/enc_dec/enc_dec_teacher_epoch_relabel/logs/screen_tedlium_dev_epoch_relabel_kl_gpu${GPU}.log
```
