#!/usr/bin/env python3
"""Aggregate ROB-66 CTC 2048-context unadapted baseline results."""
...
def write_markdown(path: Path, rows: list[dict[str, object]], source: Path) -> None:
    lines = [
        "# CTC 2048-Context Unadapted Baseline Summary",
        "",
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT,
        help="Result directory containing ROB-66 no-adapt baseline PKL files",
    )
