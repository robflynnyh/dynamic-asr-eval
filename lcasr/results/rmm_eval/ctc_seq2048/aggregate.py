#!/usr/bin/env python3
"""Aggregate ROB-68 CTC 2048-context RMM self-training eval results."""
...
RESULT_RE = re.compile(
    ...
    r"-overlap(?P<overlap>\d+)-(?P<augmentation>rmm)-epoch-(?P<epoch>\d+)"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT,
        help="Result directory containing ROB-68 RMM result PKL files",
    )
