#!/usr/bin/env python3
"""Aggregate ROB-68 scaled-time-mask RMM self-training eval results."""
...
RESULT_RE = re.compile(
    ...
    r"-overlap(?P<overlap>\d+)-(?P<augmentation>rmm-width2048-scaled)-epoch-(?P<epoch>\d+)"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT,
        help="Result directory containing ROB-68 scaled-time-mask RMM result PKL files",
    )
