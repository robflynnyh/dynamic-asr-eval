#!/usr/bin/env python3
"""Aggregate ROB-110 CTC 16384-context unadapted baseline results."""
...
def write_markdown(path: Path, rows: list[dict[str, object]], source: Path) -> None:
    lines = [
        "# CTC 16384-Context Unadapted Baseline Summary",
        "",
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT,
        help="Result directory containing ROB-110 no-adapt baseline PKL files",
    )
